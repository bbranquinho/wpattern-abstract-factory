package br.com.wpattern.abstract_factory.peasants.humans;
...
/**
 * Peasant da raça humano do tipo Middle.
 * 
 * @author Branquinho
 */
public class HumanPeasantMiddle implements IPeasant {
	...
	public HumanPeasantMiddle(String peasantName) {
